...
export default async function ArticlePage({
  ...
  // A basic parser to handle formatted paragraphs from rawContent or content
  ...
  const textContent = article.rawContent || (typeof article.content === 'string' ? article.content : '');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 items-start relative">
          ...
          <div className="lg:col-span-8 flex flex-col">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              <span className="inline-flex items-center gap-1.5 bg-[#f72e06] text-white text-[10px] font-bold px-2 py-0.5 uppercase tracking-wider shadow-sm">
                <Zap className="w-3 h-3 fill-current" />
                MARATHI NEWS
              </span>
              <span className="inline-flex items-center gap-1.5 bg-[#cd0442] text-white text-[10px] font-bold px-2 py-0.5 uppercase tracking-wider shadow-sm">
                <Zap className="w-3 h-3 fill-current" />
            ...
            {/* Headline */}
            <h1 className="text-[28px] md:text-[38px] font-bold text-[#090909] leading-tight md:leading-[1.3] break-words mb-6 md:mb-8">
              {article.title}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 mb-6 gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-[42px] h-[42px] rounded-full bg-gradient-to-br from-[#f72e06] to-[#cd0442] p-1.5 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-sm overflow-hidden">
                  <img src="/do-reports-logo.png" alt="Do Reports" className="w-full h-full object-contain brightness-0 invert" />
                </div>
                <div className="flex flex-col justify-center">
                  <div className="flex items-center gap-1.5 text-[13px] font-bold text-gray-900 mb-0.5">
                    By {article.author || "Do Reports Desk"}
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="#" className="w-9 h-9 rounded-full bg-[#090909] text-white flex items-center justify-center hover:opacity-90 transition-opacity shadow-sm">
            ...
            <div className="max-w-none">
              ...
              {textContent ? (
                ...
                <p className="text-[#333333] text-[17px] leading-[1.8] mb-6 font-medium">
                  ही बातमीची सविस्तर माहिती आहे. संबंधित अधिकाऱ्यांनी याबद्दल माहिती दिली असून पुढील काही दिवसांत याबाबत अधिकृत घोषणा होण्याची शक्यता आहे.
                </p>
              )}
            </div>
            ...
            <div className="flex flex-wrap gap-1.5 mb-8 mt-6 border-t border-gray-100 pt-6">
              {['महाराष्ट्र', 'कल्याण विकास', 'बातम्या', 'Do Reports', 'विशेष घडामोडी'].map((tag, i) => (
                <span key={i} className="inline-flex items-center gap-1.5 bg-[#090909] text-white text-[11px] font-bold px-3 py-1.5 rounded-sm hover:bg-[#cd0442] transition-colors cursor-pointer">
            ...
            <div className="flex flex-wrap sm:flex-nowrap w-full gap-2 mb-10">
              <a href="#" className="flex-1 min-w-[50px] h-[42px] bg-[#3b5998] text-white flex items-center justify-center hover:opacity-90 transition-opacity rounded-[2px] shadow-sm">
              ...
              <a href="#" className="flex-1 h-[42px] bg-[#090909] text-white flex items-center justify-center hover:opacity-90 transition-opacity rounded-[2px] shadow-sm">
            ...
            <div className="border border-dashed border-gray-400 p-6 flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-10 rounded-sm">
              <div className="w-[85px] h-[85px] rounded-full overflow-hidden flex items-center justify-center shrink-0 border border-gray-100 bg-gradient-to-br from-[#090909] via-[#b10150] to-[#cd0442] p-3">
                <img src="/do-reports-logo.png" alt="Do Reports" className="w-full h-full object-contain brightness-0 invert" />
              </div>
              <div className="flex flex-col items-center sm:items-start mt-2">
                <div className="flex items-center gap-1.5 mb-1.5">
                  <h3 className="text-[22px] font-bold text-gray-900 leading-none">{article.author || "Do Reports Desk"}</h3>
                  <BadgeCheck className="w-5 h-5 text-[#cd0442] fill-current" />
                </div>
                <p className="text-gray-600 text-sm font-medium">Special Correspondent | Do Reports</p>
              </div>
            </div>
