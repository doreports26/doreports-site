...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Header */}
      <div className="relative bg-gradient-to-br from-[#090909] via-[#14030a] to-[#090909] text-white overflow-hidden border-b border-[#cd0442]/20">
        {/* Background decorations */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-1/4 -right-1/4 w-[60%] h-[60%] rounded-full bg-[#f72e06] opacity-[0.05] blur-[120px]" />
          <div className="absolute bottom-0 left-0 w-[40%] h-[50%] rounded-full bg-[#cd0442] opacity-[0.08] blur-[100px]" />
          {/* Grid pattern */}
          <div
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-16 md:py-20 relative z-10">
          <div className="flex items-center gap-2 text-[13px] text-white/60 mb-6">
            <Link href="/" className="hover:text-[#f72e06] transition-colors">
              Home
            </Link>
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#f72e06] font-medium">Privacy Policy</span>
          </div>
          ...
          <div className="flex items-start gap-5">
            <div className="hidden md:flex w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 items-center justify-center shrink-0">
              <Shield className="w-8 h-8 text-[#f72e06]" />
            </div>
            <div>
              ...
              <p className="text-white/70 text-[15px] max-w-2xl leading-relaxed">
                ...
                <span className="text-[#f72e06] font-semibold"> Do Reports </span>
          ...
          <aside className="lg:w-[280px] shrink-0">
            <div className="lg:sticky lg:top-[80px]">
              <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <div className="px-5 py-4 bg-gradient-to-r from-[#cd0442] to-[#b10150] text-white">
                  ...
                  <ul className="flex flex-col gap-0.5">
                    {sections.map((section, i) => (
                      <li key={section.id}>
                        <a
                          href={`#${section.id}`}
                          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13px] font-medium text-gray-600 hover:bg-[#cd0442]/5 hover:text-[#cd0442] transition-colors group"
                        >
                          <span className="w-6 h-6 rounded-md bg-gray-100 group-hover:bg-[#cd0442]/10 flex items-center justify-center text-[11px] font-bold text-gray-400 group-hover:text-[#cd0442] transition-colors">
                            {i + 1}
                          </span>
                          {section.label}
                        </a>
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section id="introduction" className="mb-12 scroll-mt-24">
                ...
                <div className="policy-content">
                  <p>
                    Welcome to <strong>Do Reports</strong>, a digital news platform operated by{" "}
                    <strong>Do Reports</strong> (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). We are committed to
              ...
              <section id="advertising" className="mb-12 scroll-mt-24">
                ...
                <div className="policy-content">
                  ...
                  <ul>
                    <li>
                      <strong>Google Ad Settings:</strong> <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" className="text-[#cd0442] hover:underline">adssettings.google.com</a>
                    </li>
                    <li>
                      <strong>Network Advertising Initiative:</strong> <a href="https://optout.networkadvertising.org" target="_blank" rel="noopener noreferrer" className="text-[#cd0442] hover:underline">optout.networkadvertising.org</a>
                    </li>
                    <li>
                      <strong>Digital Advertising Alliance:</strong> <a href="https://optout.aboutads.info" target="_blank" rel="noopener noreferrer" className="text-[#cd0442] hover:underline">optout.aboutads.info</a>
                    </li>
                  </ul>
                  <p>
              ...
              <section id="contact" className="mb-8 scroll-mt-24">
                ...
                <div className="policy-content">
                  ...
                  <div className="bg-gradient-to-br from-[#cd0442]/5 to-[#f72e06]/5 border border-[#cd0442]/10 rounded-xl p-6 mt-4">
...
function SectionHeading({ icon, title }: { icon: React.ReactNode; title: string }) {
  return (
    <div className="flex items-center gap-3 mb-5 pb-3 border-b-2 border-[#cd0442]/10">
      <div className="w-10 h-10 rounded-xl bg-[#cd0442]/10 flex items-center justify-center text-[#cd0442]">
        {icon}
      </div>
