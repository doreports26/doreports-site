          ...
          <div className="lg:col-span-8 flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              ...
              <div className="col-span-1">
                <div className="flex items-center justify-between bg-primary-800 text-white px-4 py-2.5 mb-4">
                  ...
                  <a href="/category/kalyan-dombivli" className="text-xs font-medium text-primary-200 hover:text-white flex items-center transition-colors">
                ...
                <div className="flex flex-col gap-4 bg-white p-2 border border-gray-100">
                  {politicsStories.map((story, idx) => (
                    <Link href={`/article/${story.slug}`} key={idx}>
                      ...
                      <div className="flex flex-col justify-start flex-1 pt-0.5">
                        <h4 className="font-bold text-gray-800 text-[14px] leading-snug group-hover:text-primary-600 transition-colors line-clamp-3">
                          {story.title}
                        </h4>
                        <div className="flex items-center gap-1.5 text-gray-500 text-[11px] mt-1.5">
                          <Clock className="w-3 h-3" />
              ...
              <div className="col-span-1">
                <div className="flex items-center justify-between bg-primary-800 text-white px-4 py-2.5 mb-4">
                  ...
                  <a href="/category/important" className="text-xs font-medium text-primary-200 hover:text-white flex items-center transition-colors">
                    See All <ChevronRight className="w-4 h-4 ml-1" />
                  </a>
                </div>
                  ...
                  {entertainmentStories.map((story, idx) => (
                    <Link href={`/article/${story.slug}`} key={idx}>
                      ...
                      <div className="flex flex-col justify-between flex-1 py-0.5">
                        <h4 className="font-bold text-gray-800 text-[14px] leading-[1.4] group-hover:text-primary-600 transition-colors line-clamp-3 -mt-[3px]">
                          {story.title}
                        </h4>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center justify-between bg-[#0B4A99] text-white px-4 py-3 mb-6">
                ...
                <a href="/category/special" className="text-sm font-bold text-white hover:text-gray-200 flex items-center transition-colors">
                  See All <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-2xl text-gray-900">Welfare</h3>
                </div>
                <a href="/category/welfare" className="bg-[#0B4A99] text-white px-4 py-1.5 rounded-sm text-sm font-bold flex items-center hover:bg-blue-800 transition-colors">
                  See All <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center justify-between bg-[#0B4A99] text-white px-4 py-3 mb-6">
                ...
                <a href="/category/education" className="text-sm font-bold text-white hover:text-gray-200 flex items-center transition-colors">
                  See All <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </div>
                ...
                {topStories.map((story, idx) => (
                  <Link href={`/article/${story.slug}`} key={idx}>
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-start flex-1 pt-0.5">
                        <h3 className="font-bold text-gray-900 line-clamp-3 group-hover:text-[#0B4A99] transition-colors leading-snug text-[13px]">
                          {story.title}
                        </h3>
                        <div className="flex items-center gap-1.5 text-gray-500 text-[11px] mt-1.5">
                          <Clock className="w-3 h-3" />
