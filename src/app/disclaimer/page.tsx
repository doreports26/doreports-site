...
export const metadata: Metadata = {
  title: "Disclaimer | थोडक्यात News",
  description:
    "Read the Disclaimer of थोडक्यात (Thodkyaat) News. Understand the terms regarding the use of information published on our news website.",
};
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-white/70 text-[15px] max-w-2xl leading-relaxed">
                ...
                <span className="text-[#ffc20e] font-semibold">थोडक्यात (Thodkyaat)</span> website.
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-[13px] text-gray-700 leading-relaxed">
              ...
              <strong>Implant Media Pvt. Ltd.</strong> makes no representations or warranties of any kind about the
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section id="general" className="mb-12 scroll-mt-24">
                ...
                <div className="policy-content">
                  <p>
                    The information contained on the <strong>थोडक्यात (Thodkyaat)</strong> website, operated by{" "}
                    <strong>Implant Media Pvt. Ltd.</strong> (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), is provided for
              ...
              <section id="editorial" className="mb-12 scroll-mt-24">
                ...
                <div className="policy-content">
                  <p>
                    थोडक्यात is a news and media platform that publishes news articles, breaking news alerts,
                ...
                <div className="policy-content">
                  ...
                  <ul>
                    <li>
                      ...
                      and do not necessarily reflect the editorial position, views, or policies of थोडक्यात or Implant
                      Media Pvt. Ltd.
                    </li>
                    <li>
              ...
              <section id="copyright" className="mb-12 scroll-mt-24">
                ...
                <div className="policy-content">
                  <p>
                    ...
                    <strong>Implant Media Pvt. Ltd.</strong> or its content suppliers and is protected by Indian and
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      provided proper attribution is given to थोडक्यात.
                    </li>
                    <li>
                    ...
                    <li>
                      Our brand name &quot;थोडक्यात&quot;, logo, and associated visual identity are trademarks of Implant Media
                      Pvt. Ltd. and may not be used without written authorization.
                    </li>
                  </ul>
                  <p>
                ...
                <div className="policy-content">
                  <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-r-lg mb-4">
                    ...
                    <p className="text-[13px] text-red-700">
                      Please read this section carefully as it limits the liability of Implant Media Pvt. Ltd. and its
                      affiliates.
                    </p>
                  </div>

                  <p>
                    To the fullest extent permitted by applicable law, Implant Media Pvt. Ltd., its directors, officers,
              ...
              <section id="indemnification" className="mb-12 scroll-mt-24">
                ...
                <div className="policy-content">
                  <p>
                    You agree to indemnify, defend, and hold harmless Implant Media Pvt. Ltd., its directors, officers,
