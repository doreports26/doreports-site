...
export function LatestNewsWidget() {
  const newsList = [
    ...
    {
      id: 3,
      title: "आज राज्यात पाऊस हजेरी लावणार; 'या' 11 जिल्ह्यांना येलो अलर्ट जारी",
      date: "August 25, 2026",
      imageTag: "हवामान"
    },
    {
    ...
    <div className="w-full flex flex-col font-sans bg-white pt-2">
      ...
      <div className="flex flex-col">
        {newsList.map((news, index) => (
          <div 
            key={news.id} 
            className={`flex items-start justify-between py-5 border-b border-gray-100 group cursor-pointer ${index === newsList.length - 1 ? 'border-b-0' : ''}`}
          >
            {/* Title & Date */}
